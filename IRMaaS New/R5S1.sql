...
-- ALTER TABLE CLNT_VULN_INSTC ADD VULN_CLOS_DT DATETIME,VULN_CLOS_DT DATETIME,CLOS_RSN_TXT TEXT;
...
GO
/****** Object:  StoredProcedure [dbo].[Report_FindingByCategory]    Script Date: 2/22/2017 5:06:01 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
ALTER PROCEDURE  [dbo].[Report_FindingByCategory]
(
...
JOIN		'+ @SchemaName+ '.CLNT_ROADMAP_FACT		B
ON			A.VULN_CATGY_CD						=	B.VULN_CATGY_CD
AND			A.CLNT_ENGMT_CD						=	B.CLNT_ENGMT_CD
