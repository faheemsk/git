...
(function ($) {
    ...
    $.fn.columnFilter = function (options) {
        ...
        /*
         Create Date Input
         */
         function fnCreateDateInput(oTable) {
	        ...
	        function (oSettings, aData, iDataIndex) {
	            ...
	            var dEndDate = from.datepicker("getDate");
...
//						oTable.fnFilter(unescape($(this).val()), iColumn); //Issue 25
                                        ...
                                        //Modified code for exact match when select box drop down value.
                                        if ($(this).val() != "") {
                                            $(this).removeClass("search_init");
                                            if (bRegex)
