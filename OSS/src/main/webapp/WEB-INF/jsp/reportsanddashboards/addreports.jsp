<%-- 
    Document   : addreports
    Created on : Jul 1, 2016, 10:28:36 AM
    Author     : schanganti
--%>
    ...
    <head>
        <META content="IE=9" http-equiv="X-UA-Compatible">
            <META content="text/html; charset=utf-8" http-equiv="Content-Type">
                ...
                <link rel="stylesheet" href="<c:url value="/appcss/addreports.css"/>" />
                ...
                <body>
                    ...
                    <div id="ux-wrapper">
                        ...
                        <ul class="ux-brdc ux-margin-left-1t" >
                             ...
                             <li><a href="#" onclick="headerFn('reportsuploadworklist.htm')">Reporting Documents</a></li> 
                            <li>Add Report</li> 
                        </ul>
                        ...
                        <div id='popupbox' class="ux-modl">
                            ...
                            <div class="ux-modl-content">
                                ...
                                <div class="ux-margin-1t  " align="center">
                                    <input type="button" title="OK" value="OK" class="ux-btn-default-action ux-width-7t" onclick="deleteuploadfilelist()" id="msgshow"/>
                        ...
                        <div class="ux-content"> 
                            <h1>Add Reports <span class="ux-float-right">
                                    <c:if test="${permissions.contains(permissionConstants.VIEW_DASHBOARD)}">
                                        ...
                                        <input type="button" value="Back" title="Back" class="ux-btn-default-action" onclick="headerFn('reportsuploadworklist.htm')" /> </span>
                            </h1>
                            ...
                            <form name="saveUploadReportFile" action="#" method="POST" id="saveUploadReportFile" commandName="saveReports"  enctype="multipart/form-data">
                                    ...
                                    <div class="ux-panl-content">
                                        <div class="ux-hform">
                                            ...
                                            <dl class="LongTxt">
                                                ...
                                                <dd> <div id="multipleupload">
                                                        <input name="templateupload" type="file" id="templateupload"></input>
                                                    </div>
                                                    <c:choose>
                                        ...
                                        <input type="hidden" value="A" name="redirectFlag"/>
                                        </form>
                                        <div id="reportlist">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <c:forEach var="serviceListIte" items="${uploadFileList}">
                                                                <tr>
                                                                    ...
                                                                    <!-- <input type="hidden" name="reportNameCheckId" 
                                                                                                                                                   value="${serviceListIte.uploadFileKey}@${serviceListIte.rowStatusKey}@${serviceListIte.reportName}@${serviceListIte.fileName}@${serviceListIte.filePath}@${serviceListIte.status}" />-->
                                                                    <td>${serviceListIte.reportName}</td>
                                                                    <c:choose>
                                                                        <c:when test="${serviceListIte.rowStatusKey == constants.DB_CONSTANT_FILE_STATUS_KEY_SCAN_INPROGRESS || 
                                                                                    serviceListIte.rowStatusKey == constants.DB_CONSTANT_FILE_STATUS_KEY_SCAN_FAILED}">
                                                                        ...
                                                                        <c:if test="${serviceListIte.rowStatusKey != constants.DB_ROW_STATUS_PUBLISHED_VALUE}">
                                                                            <c:choose>
                                                                                ...
                                                                                <c:when test="${serviceListIte.rowStatusKey == constants.DB_ROW_STATUS_NOTPUBLISHED_VALUE}">
                                                                                    <a href="#" onclick="deleteUploadedFile('${serviceListIte.uploadFileKey}')" title="Delete" class="ux-icon-delete">Delete</a>
                                                                                </c:when>
                                                                                <c:otherwise>
                                                                                    <%--<c:choose>--%>
                                                                                        <%--<c:when test="${serviceListIte.rowStatusKey == constants.DB_CONSTANT_FILE_STATUS_KEY_SCAN_INPROGRESS}">--%>
                                                                    ...
                                                                    <input type="hidden" name="encUploadFileID${serviceListIte.uploadFileKey}" id="encUploadFileID${serviceListIte.uploadFileKey}"  value="${serviceListIte.encUploadFileKey}"/>
                                                                </tr>
                                                            </c:forEach>
                                                        </tbody>
                                                    </table>
                                ...
                                <%--<c:if test="${permissions.contains(prmnsConstants.PUBLISH_REPORTS)}"></c:if>--%>
                                <!--                                <input type="button" value="Publish" title="Publish" class="ux-btn-default-action" id="msg"/> -->
                                ...
                                <!--                                <input type="button" value="Cancel" class="ux-btn-default-action" onclick="window.location.href = 'Client-Reports-Upload.html'" /> -->
                                <input name="" type="button" value="Cancel" title="Cancel" class="ux-btn-default-action " id="fnCancelAddReload"/>

                                <form name="addUploadFiledetails" action="#"  id="addUploadFiledetails" method="post">
                                    <input type="hidden" value="A" name="redirectFlag"/>
                                ...
                                <form name="toCancelReloadAddForm" action="#"  id="toCancelReloadForm" method="post">
