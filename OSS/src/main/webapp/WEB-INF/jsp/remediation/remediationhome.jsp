...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <link rel="stylesheet" href="<c:url value="/appcss/remediationhome.css"/>" />
        <!-- CSS : Include -->
        <!-- JS : Include -->
        <jsp:include page="../includes/commonjs.jsp"/>
        <script type="text/javascript" src="<c:url value="/appjs/remediationhome.js"/>"></script>
        <!-- JS : Include -->  
        <!-- Header : Include -->
                        ...
                        <thead>
                            ...
                            <tr>
                                ...
                                <td class="ux-padding-left-1t ux-padding-bottom-1t">
                                    ...
                                    <a href="#" onclick="headerFn('remediationhome.htm')"><img src="images/refresh.png" title="Refresh"/></a>
                                </td>
                            </tr>
                        </thead>
                        <tbody>
                                                                ...
                                                                <td valign="top" style="border-right-width: 1px !important;">
                                                                    <%--<c:if test="${permissions.contains(prmnsConstants.REMEDIATE)}">--%>
                                                                        <a href="javascript:void(0)"
                                                                           title="Remediation" class="ux-icon-review" onclick='remediationPlan("${fn:trim(serviceListIte.encClientEngagementCode)}")'>Remediation</a>
                                                                    <%--</c:if>--%>
                                                                </td> 
                                                            </c:if>
