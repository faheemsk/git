...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <script type="text/javascript" src="<c:url value="/appjs/manageengusers.js"/>"></script>
        <!-- JS : Include -->  
        <!-- Header : Include -->
                        ...
                        <tbody>
                            <c:forEach var="engagementDTO" items="${engagementsList}">
                                <tr>
                                    ...
                                    <td>
                                        <a href="#" onclick='$.fn.mnguser("${fn:trim(engagementDTO.encEngagementCode)}")' class="ux-icon-service" title="Manage Users">Manage Users</a>
                                    </td>
