 ...
 * @author rpanuganti
 */
public interface RiskRegistryService {

    public List<ManageServiceUserDTO> fetchRiskRegistryWorklist(final UserProfileDTO userDto,
    ...
    public int updateFindingCountRegistryAnsPlan(int RegistryID, int findingCount, long userID, String orgSchema, String flag) throws AppException;
