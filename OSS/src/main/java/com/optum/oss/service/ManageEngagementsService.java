 ...
 * @author sbhagavatula
 */
public interface ManageEngagementsService {
    ...
    public int updateEngagement(final ClientEngagementDTO clientEngagementDTO, final UserProfileDTO sessionDTO) throws AppException;
