 ...
 */
@Component
public class UpdateEngagementValidator implements Validator{
    
    private static final Logger logger = Logger.getLogger(UpdateEngagementValidator.class);
    ...
    //                }
            ...
            e.printStackTrace();
            logger.debug("Exception occured : UpdateEngagementValidator: validate(): " + e.getMessage());
        }
    }
